...
public class Noise
{
    ...
    const float F3 = 0.333333333f; // F3 = 1/3
    const float G3 = 0.166666667f; // G3 = 1/6
    ...
    private readonly Random _random;    // The random object used to randomize the noise
    private readonly int _seed;         // The random seed used to create the noise.
    ...
    /// <summary>Gets a value representing the seed for this noise generator.</summary>
    ...
    /// <summary>
    /// Calculates a random value given a 1-dimensional input and scale.
    /// </summary>
    /// <param name="x">The 1-dimensional input.</param>
    /// <param name="scale">The scale factor.</param>
    /// <returns>A simplex noise-based random value.</returns>
    public float CalcPixel1D(int x, float scale) 
        => Generate(x * scale) * 128 + 128;

    /// <summary>
    /// Calculates a random value given a 2-dimensional input and scale.
    /// </summary>
    /// <param name="x">The x-factor of the 2D input.</param>
    /// <param name="y">The y-factor of the 2D input.</param>
    /// <param name="scale">The scale factor.</param>
    /// <returns>A simplex noise-based random value.</returns>
    ...
    /// <summary>
    /// Calculates a random value given a 3-dimensional input and scale.
    /// </summary>
    /// <param name="x">The x-factor of the 3D input.</param>
    /// <param name="y">The y-factor of the 3D input.</param>
    /// <param name="z">The z-factor of the 3D input.</param>
    /// <param name="scale">The scale factor.</param>
    /// <returns>A simplex noise-based random value.</returns>
    ...
    /// <summary>
    /// Floors the provided float and returns an int.
    /// </summary>
    /// <param name="x"></param>
    /// <returns>An integer containing the floored value of x.</returns>
